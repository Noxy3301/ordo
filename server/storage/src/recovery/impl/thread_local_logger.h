 ...
 */
#ifndef HELIOS_STORAGE_SRC_RECOVERY_IMPL_THREAD_LOCAL_LOGGER_H
#define HELIOS_STORAGE_SRC_RECOVERY_IMPL_THREAD_LOCAL_LOGGER_H
...
#endif  // HELIOS_STORAGE_SRC_RECOVERY_IMPL_THREAD_LOCAL_LOGGER_H
